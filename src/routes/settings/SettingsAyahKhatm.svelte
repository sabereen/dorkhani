...
<form action="" onsubmit={handleSubmit}>
	...
	>
		<legend class="ui-fieldset-legend">{legend}</legend>

		<label for="input-translation" class="ui-field-label">ترجمه</label>
		<select
		...
		{#if fontProxy}
			<label for="input-font" class="ui-field-label">فونت</label>
		...
		<select id="input-reciter" class="ui-select" name="reciter" bind:value={editor.config.reciter}>
		...
		<input disabled={!editor.dirty} class="ui-btn ui-btn-primary mt-3" type="submit" value="ذخیره" />
	</fieldset>
</form>
